                ...
                <div className="container-fluid">
                    ...
                    <div className="col-lg-4">
                        ...
                        <li>
                            ...
                            <img className="img-fluid" src="/img/images/img%20(9).jpg" alt="" />
                            <a>
                        ...
                        <li>
                            <div className="view overlay hm-white-slight z-depth-1">
                            <img className="img-fluid" src="/img/images/img%20(20).jpg" alt="" />
                            <a>
                                <div className="mask waves-light waves-effect waves-light" />
                            </a>
                            </div>
                        ...
                        <li>
                            <div className="view overlay hm-white-slight z-depth-1">
                            <img className="img-fluid" src="/img/images/img%20(19).jpg" alt="" />
                            <a>
                                <div className="mask waves-light waves-effect waves-light" />
                            </a>
                            </div>
                        ...
                        <li>
                            <div className="view overlay hm-white-slight z-depth-1">
                            <img className="img-fluid" src="/img/images/img%20(16).jpg" alt="" />
                            <a>
                                <div className="mask waves-light waves-effect waves-light" />
                            </a>
                            </div>
                        ...
                        <li>
                            <div className="view overlay hm-white-slight z-depth-1">
                            <img className="img-fluid" src="/img/images/img%20(5).jpg" alt="" />
                            <a>
                                <div className="mask waves-light waves-effect waves-light" />
                            </a>
                            </div>
                        ...
                        <li>
                            <div className="view overlay hm-white-slight z-depth-1">
                            <img className="img-fluid" src="/img/images/img%20(18).jpg" alt="" />
                            <a>
                                <div className="mask waves-light waves-effect waves-light" />
                            </a>
                            </div>
                        ...
                        <li>
                            <div className="view overlay hm-white-slight z-depth-1">
                            <img className="img-fluid" src="/img/images/img%20(15).jpg" alt="" />
                            <a>
                                <div className="mask waves-light waves-effect waves-light" />
                            </a>
                            </div>
                        ...
                        <li>
                            <div className="view overlay hm-white-slight z-depth-1">
                            <img className="img-fluid" src="/img/images/img%20(17).jpg" alt="" />
                            <a>
                                <div className="mask waves-light waves-effect waves-light" />
                            </a>
                            </div>

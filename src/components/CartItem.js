    ...
    render() {
        ...
        return (
            <tr>
                ...
                <td>
                    <button onClick={ () => this.onDeleteProduct(item.product) } type="button" className="btn btn-sm btn-primary waves-effect waves-light" data-toggle="tooltip" data-placement="top" data-original-title="Remove item">
                    X
                    </button>
                </td>
            </tr>
